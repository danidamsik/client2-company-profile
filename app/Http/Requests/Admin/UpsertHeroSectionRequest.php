...
class UpsertHeroSectionRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'primary_cta_message' => $this->cleanInput($this->input('primary_cta_message')),
    ...
    public function rules(): array
    {
        return [
            ...
            'primary_cta_message' => ['nullable', 'string', 'max:500'],
    ...
    public function messages(): array
    {
        return [
            ...
            'primary_cta_message.max' => 'Pesan default WhatsApp maksimal 500 karakter.',
